...
appended by the benchmark's own recording tail rather than by the suite. That
is what makes a single ``anthro eval puzzles`` reading carry its cost too,
which matters because the sweep is not how most single-benchmark readings are
taken.
