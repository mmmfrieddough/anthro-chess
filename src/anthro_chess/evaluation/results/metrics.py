...
BENCHMARK_WALL_CLOCK_SECONDS = register_metric(
    MetricDefinition(
        ...
        summary=(
            ...
            "its first statement to the moment it finished assembling what it "
            "recorded. Interpreter startup and the store append are outside it, "
            "so a sweep's total is the sum of its steps plus what the driver "
            "itself pays."
        ),
        cost=MetricCost.MEASURED_EXECUTION,
        execution_sensitive=True,
