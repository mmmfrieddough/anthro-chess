...
def test_the_default_text_view_stays_readable(
    ...
    # generated play, novelty, and training efficiency, which have metrics but
    # no result in this fixture; a family gets its own actionable absence
    # section as soon as it has a metric to be absent.
