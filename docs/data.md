...
the packing and, under the shard-backed loader, a quarter of what each batch
pickles on its way out of a worker. Padding is right-aligned throughout, which
is what lets a padded row's outputs be ignored rather than masked away.
